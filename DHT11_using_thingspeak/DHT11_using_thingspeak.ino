...
String apiKey = "AK8KKW5DEY931HGK";     //  Enter your Write API key from ThingSpeak

const char *ssid =  "Al";     // replace with your wifi ssid and wpa2 key
const char *pass =  "balde111";
